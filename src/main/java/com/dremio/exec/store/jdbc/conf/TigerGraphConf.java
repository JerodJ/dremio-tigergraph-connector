...
@SourceType(value = "TigerGraphARP", label = "TigerGraph",uiConfig = "tigergraph-layout.json")
public class TigerGraphConf extends AbstractArpConf<TigerGraphConf> {
  private static final String ARP_FILENAME = "arp/implementation/tigergraph-arp.yaml";
  private static final ArpDialect ARP_DIALECT =
      AbstractArpConf.loadArpFile(ARP_FILENAME, (ArpDialect::new));
  private static final String DRIVER = "cdata.jdbc.tigergraph.TigerGraphDriver";
